                  ...
                  <td className="p-4">
                    <div className="flex items-center gap-3">
                      {review.product?.image ? (
                        <img src={review.product.image?.startsWith('/uploads') ? API_BASE_URL + review.product.image : review.product.image} className="w-10 h-10 rounded object-cover border border-gray-200" alt="Product" />
                      ) : (
