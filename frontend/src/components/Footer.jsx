      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex space-x-8">
            <a href="#" className="text-gray-400 hover:text-orange-500 font-bold transition-colors">About Us</a>
            <a href="#" className="text-gray-400 hover:text-orange-500 font-bold transition-colors">Customer Service</a>
            <a href="#" className="text-gray-400 hover:text-orange-500 font-bold transition-colors">Privacy Policy</a>
            <a href="#" className="text-gray-400 hover:text-orange-500 font-bold transition-colors">Terms</a>
          </div>
        </div>
