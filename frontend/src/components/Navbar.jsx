        ...
        <div className="flex items-center gap-6">
          ...
          {user ? (
            <div className="relative group cursor-pointer z-50">
              ...
              {/* Dropdown Menu */}
              <div className="absolute top-[100%] right-0 w-64 pt-2 opacity-0 translate-y-3 pointer-events-none group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto transition-all duration-300">
                  ...
                  <div className="absolute top-[100%] left-1/2 -translate-x-1/2 pt-2 opacity-0 translate-y-3 pointer-events-none group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto transition-all duration-300 w-[240px] z-[9999]">
                    <div className="bg-white rounded-lg shadow-2xl border border-gray-100 overflow-hidden transform origin-top scale-95 group-hover:scale-100 transition-transform duration-300">
                      ...
                      <div className="p-3 bg-gray-50 text-center border-t border-gray-200 hover:bg-orange-600 group/btn transition-colors cursor-pointer">
                        <Link to="/" className="text-xs font-black text-black group-hover/btn:text-white uppercase tracking-widest block transition-colors">Shop All {category}</Link>
                      </div>
                    </div>
                  </div>
                </div>
